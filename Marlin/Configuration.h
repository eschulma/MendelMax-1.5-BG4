...
#define STRING_CONFIG_H_AUTHOR "(Erica Kane, MendelMax 1.5 BG4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MendelMax 1.5 BG4"
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 44.44, 44.44, 2584.2, 885 }
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 44.44, 44.44, 2584.2, 838.0 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 200, 200, 25, 50 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 39.0, -0.1, -2.3 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
// ESK: this must be GREATER than the X or Y distance between the probe and the nozzle,
// otherwise the nozzle may hit a clip
